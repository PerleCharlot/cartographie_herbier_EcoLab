#============================================================================
# nom : Fonction de découpage d'un raster drone
...
green <- raster("rasterdata/mosaiquedrone.TIF", band = 1)
blue <- raster("rasterdata/mosaiquedrone.TIF", band = 2)
red <- raster("rasterdata/mosaiquedrone.TIF", band = 3)

# *************
# * Fonctions *
# *************

decoupageRaster <- function(masque, green, blue, red){
  ...
  #17h30 de calcul pour la fonction masque sur drone....
...
raster <- decoupageRaster(masque, green, blue, red)